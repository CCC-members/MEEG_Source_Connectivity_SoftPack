function [sigma,theta,process,process_energe,SigmaEpir,ThetaEpir] = gen_processes(Nsegments,Nseed,options)
...
process_energe = sigma_to_band_energy((options.Ntpoints)*sigma,...
