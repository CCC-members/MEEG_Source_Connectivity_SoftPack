function [] = figure_occ_harmonics(F_task,PSD_task,freq,output_sourse)
figure_occ_harmonics = figure; 
...
text(F_task(superh1),PSD_task(9,superh1),txt);
 ...
 saveas( figure_occ_harmonics,strcat(output_sourse,filesep,'power-spectral-density task-segments_',num2str(freq),'.fig'));
    disp(strcat('Saving figure ---->  power-spectral-density task-segments  to  ---> ', output_sourse) );
    delete(figure_occ_harmonics);
